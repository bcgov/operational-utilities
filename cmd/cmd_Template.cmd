...
set Usage1="  [/?]             Optional. Display the Help info, defaults to FALSE"
set Usage2="  [/t | /T]        Optional. Test run or dry run, defaults to FALSE"
set Usage3="  [[/p | /P]:Path] Optional. Path to a directory. e.g. /P:C:\dvlp\temp. Defaults to [Path_to_Check]."
...
set Example7="."
set Remark0="Remarks:"
set Remark1="- Set the EffArg_Required to the number of mandatory arguments."
set Remark2="- Set Max_Help_Items to the maximun items in the head sections."
set Remark3="- Please replace head sections with your own notes."
set Remark4="."
